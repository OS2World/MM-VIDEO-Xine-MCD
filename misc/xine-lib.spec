...
URL:            http://xinehq.de
Source:         http://xinehq.de/files/xine-lib-1-rc2.tar.gz
...
%description -l cs
libxine je tepající srdce xine (volnì ¹iøitelného videopøehrávaèe pod gpl
...
Dokud to bude ve shodì s GPL, neváhejte pou¾ít libxine ve va¹ich vlastních
projektech.
...
Summary(cs):    Hlavièkové soubory a dokumentace pro vývoj programù pou¾ívajících libxine.
...
programù pou¾ívajících libxine.
