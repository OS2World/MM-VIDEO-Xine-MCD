...
#define PACKAGE_BUGREPORT "doconnor@reamined.on.ca"

/* Define to the full name of this package. */
#define PACKAGE_NAME "xine for OS/2"
...
#define XINE_FONTDIR xine_home("fonts")
...
#define XINE_PLUGINDIR xine_home("plugins")
